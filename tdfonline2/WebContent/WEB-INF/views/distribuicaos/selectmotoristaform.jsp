...
<spring:url value="/distribuicaos/selectmotorista2" var="selectUrl" />
	...
	<form:form class="form-horizontal" 
                modelAttribute="motorista" action="${selectUrl}">
		
		<spring:bind path="nome">
		  <div class="form-group ${status.error ? 'has-error' : ''}">
			<label class="col-sm-2 control-label">Nome Motorista</label>
			<div class="col-sm-10">
			...
			<c:forEach var="motorista" items="${motoristas}">
				...
				<td>
				  ...
				  <button class="btn btn-info" 
                                          onclick="location.href='${distribuicaoUrl}'">Selecionar</button>
