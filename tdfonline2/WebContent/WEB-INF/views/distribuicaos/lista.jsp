...
<div class="container">
	...
	<div   class="text-center text-uppercase font-weight-bold">
		<h4  class="h4 font-weight-bold">Relação das viagens</h4>
	</div>
	...
	<div  class="row areanotify justify-content-end py-1">		
		...
		<table id="Tabela" class="table table-striped table-hover display"  style="width:100%">
			<thead>
				<tr>
					...
					<th class="text-center hidea">Veículo</th>
			...
			<c:forEach var="distribuicao" items="${distribuicaos}">
				...
				<td class="text-center hidea">${distribuicao.veiculo.descricao}</td>
				<td class="text-center data">${distribuicao.dataviagem}</td>				
		...
		<div class="row justify-content-center text-center mt-3 animated fadein" >			
			...
			<i class="fas fa-plus-square mx-3"></i><span class="hidea"> Nova Viagem</span></a>
		</div> 
