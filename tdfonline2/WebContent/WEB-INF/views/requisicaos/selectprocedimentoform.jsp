...
<body>
	...
	<div class="container">
		...
		<spring:url value="/requisicaos/selectprocedimento2" var="selectprocedimentoUrl" />
		...
		<table class="table table-striped table-hover display" >
			...
			<c:forEach var="procedimento" items="${procedimentos}">
				...
				<td class="text-center">
				  <spring:url value="/requisicaos/selectprocedimento/${procedimento.id}" var="selectprocedimentoUrl" />
