...
<spring:url value="/beneficioavulsos/selectprocedimento2" var="selectprocedimentoUrl" />
	...
	<c:if test="${not empty procedimentos}">
		...
		<table class="table table-striped">
			...
			<c:forEach var="procedimento" items="${procedimentos}">
				...
				<td>
				  <spring:url value="/beneficioavulsos/selectprocedimento/${procedimento.id}" var="selectprocedimentoUrl" />
