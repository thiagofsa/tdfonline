...
<spring:url value="/beneficioavulsos/selectunidadesaude2" var="selectunidadesaudeUrl" />
	...
	<c:if test="${not empty unidadesaudes}">
		...
		<table class="table table-striped">
			...
			<c:forEach var="unidadesaude" items="${unidadesaudes}">
				...
				<td>
				  <spring:url value="/beneficioavulsos/selectunidadesaude/${unidadesaude.id}" var="selectunidadesaudeUrl" />
