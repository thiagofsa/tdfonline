...
<div class="container">
	...
	<div   class="text-center text-uppercase">
		<h4  class="h4 font-weight-bold">Relação dos Encaminhamentos de Retorno</h4>
	</div>
	...
	<div  class="row areanotify justify-content-end py-1">		
		...
		<table id="Tabela" class="table table-striped table-hover display"  style="width:100%">
			...
			<c:forEach var="encaminhamentovolta" items="${encaminhamentovoltas}">
			    <tr>
				<td>${encaminhamentovolta.paciente.nome}</td>
				<td class="text-center">${encaminhamentovolta.dataviagem}</td>
				<td class="text-center">${encaminhamentovolta.distribuicao.veiculo.descricao}</td>				
