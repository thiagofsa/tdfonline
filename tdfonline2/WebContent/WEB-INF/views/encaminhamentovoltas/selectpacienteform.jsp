...
<spring:url value="/encaminhamentovoltas/selectpaciente2" var="selectUrl" />
	...
	<form:form  class="form-row align-items-center"  modelAttribute="paciente" action="${selectUrl}">	
		...
		<div class="3">				
			<button type="submit" class="btn btn-outline-success"><i class="fas fa-check-circle"></i> <span class="esconder"> Pesquisar</span></button>				
		</div>
	...
	<c:if test="${not empty pacientes}">
		...
		<table class="table table-striped">
			...
			<c:forEach var="paciente" items="${pacientes}">
				...
				<td>
				  <spring:url value="/encaminhamentovoltas/selectpaciente/${paciente.id}" var="encaminhamentovoltaUrl" />
